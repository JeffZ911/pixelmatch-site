...
1.  **Audit your current catalog:** Use [Shopify Sidekick](https://pixelmatch.art/blog/policy/shopify-sidekick-ai-image-generator-tutorial) to find low-converting product pages. Simply type: "Show me my top 20 products by traffic that have a conversion rate under 1.5%." These are your first candidates for an [AI image](https://pixelmatch.art/blog/policy/shopify-sidekick-ai-image-generator-tutorial) refresh.
