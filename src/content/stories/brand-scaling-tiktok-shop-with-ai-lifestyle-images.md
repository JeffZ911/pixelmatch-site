...
Second, you must remain compliant with the TikTok Shop Product Listing Guidelines, Section 3.1, which strictly prohibits misleading [product listings](https://pixelmatch.art/blog/policy/amazon-rufus-seo-product-listings-guide). AI-generated lifestyle scenes must accurately represent the product's true scale. For example, do not use an AI background that makes a 1oz serum bottle look like a 10oz bottle next to a sink. Additionally, the images cannot imply false physiological results (e.g., "before and after" skin textures generated by AI). The product itself must remain an unedited representation of what the customer will receive.
