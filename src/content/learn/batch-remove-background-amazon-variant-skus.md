...
No. For the `.MAIN` image, Amazon policy requires a "pure white" background. AI-generated [lifestyle backgrounds](https://pixelmatch.art/blog/stories/krea-2-turbo-ecommerce-lifestyle-backgrounds) (like a kitchen counter or a park bench) are excellent for your secondary images (`PT01` through `PT99`) to increase conversion, but using them for your primary image will result in a listing suppression.
